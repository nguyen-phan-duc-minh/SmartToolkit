  ...
  void _calculateResult() {
    ...
    setState(() {
      if (_operation.isNotEmpty) {
        double currentResult = _calculate(_operand, inputValue, _operation);
        _display = _formatNumber(currentResult);
        _expression = '${_formatNumber(_operand)} $_operation ${_formatNumber(inputValue)} =';
        _operation = '';
        _operand = 0;
        _waitingForOperand = true;
      }
            ...
            child: Container(
              ...
              child: Column(
                children: [
                  ...
                  Row(
                    children: [
                      _buildButton(text: '7', onPressed: () => _inputDigit('7')),
                      _buildButton(text: '8', onPressed: () => _inputDigit('8')),
                      _buildButton(text: '9', onPressed: () => _inputDigit('9')),
                      _buildButton(
                        text: '×',
                        onPressed: () => _performOperation('×'),
                        backgroundColor: colorScheme.primaryContainer,
                  ...
                  Row(
                    children: [
                      _buildButton(text: '4', onPressed: () => _inputDigit('4')),
                      _buildButton(text: '5', onPressed: () => _inputDigit('5')),
                      _buildButton(text: '6', onPressed: () => _inputDigit('6')),
                      _buildButton(
                        text: '-',
                        onPressed: () => _performOperation('-'),
                        backgroundColor: colorScheme.primaryContainer,
                  ...
                  Row(
                    children: [
                      _buildButton(text: '1', onPressed: () => _inputDigit('1')),
                      _buildButton(text: '2', onPressed: () => _inputDigit('2')),
                      _buildButton(text: '3', onPressed: () => _inputDigit('3')),
                      _buildButton(
                        text: '+',
                        onPressed: () => _performOperation('+'),
                        backgroundColor: colorScheme.primaryContainer,
